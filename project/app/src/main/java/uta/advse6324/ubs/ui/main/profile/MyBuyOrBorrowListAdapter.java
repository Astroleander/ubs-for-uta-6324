...
public class MyBuyOrBorrowListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyBuyOrBorrowListAdapter(ArrayList<Merchandise> list, Context ctx, User u) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_profile_my_buy_or_borrow, parent, false));
    }
